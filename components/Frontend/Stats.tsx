...
export default function Stats () {
    ...
    return (
        <section className="py-14">
            <div className="max-w-screen-xl mx-auto px-4 text-neutral-600 gap-x-12 justify-between md:px-8 lg:flex">
                <div className="max-w-2xl mx-auto text-center lg:text-left lg:mx-0">
                    <h3 className="text-neutral-800 text-3xl font-semibold sm:text-4xl">
